function waitForPlotly_fig() {
    ...
    if (myElement) {
        ...
        list_buttons_request_dataset.appendChild(in_greenlight)
        list_buttons_request_dataset.appendChild(lab_greenlight)
...
function update_range_datetime_cells(){
    in_dt_cells.max = DATA['Time'].length
